...
- <b>NOT DONE</b>: Auto "Post Array" Title/Date nameing convention, Currently you add to type H1-Title & Date line in IMP! 
#### Issues
...
- Fully supports add in (it doesnt have any currently), js powered, json/xml (& geojson/kml), flat file, databases.
...
- Convert all CSS to IMP!'s "Gutenberg" style, with (a cleaner) Zonelet's "Menu/Header/Footer" updating menu/post array (aka: match structure/style)
