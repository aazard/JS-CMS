...
- Fully supports add in (it doesnt have any currently) json (& geojson)/xml (& rss, kml), flat file, databases.
- For best results, of "on host files", please use webp (& gif, svg, ico) images & MIDI (mid & midi) audio
